...
<head>
  ...
  <title>Admin panel | Invoice</title>
...
<div class="invoice-container">
  ...
  <section class="customer-info">
    ...
    <p><strong class="form-label">Customer Name:</strong>
    <input type="text" class="form-control" id="username" name="username" value="" required></p>
    <p><strong class="form-label">Email:</strong>
    <input type="email" class="form-control" id="email" name="email" value="" required></p></p>
  </section>
  ...
  <footer>
    <a href="admin panel.html" class="btn btn-primary">Back to Panel</a>
